...
impl StackMapType {
    fn from_desc(
        ...
        Ok(match desc {
            ...
            // TODO: How do we represent this? We haven't actually turned this into an array type
            // yet.
        ...
        for frame in smt.entries {
            ...
            match frame {
                ...
                StackMapFrameCF::ChopFrame {
                    ...
                    // TODO: this could be simplified if DoubleEndedIterators had a skip_reverse method
                    // so as to skip methods at the end
                    // TODO: error if missing is greater than the number of local variables available
                    ...
                    let locals = stack_frames
                        ...
                        .locals
                        .iter()
                        .skip(existing - missing as usize)
                        .cloned()
                        .collect::<Vec<_>>();
                    let frame = StackMapFrame {
                        at: stack_frames.get_new_index(offset_delta),
                ...
                // Same locals, but with some a dditional locals
                // Empty operand stack
