...
J_FILES=""
# java/lang
JFILES="$JFILES ./java/lang/Class.java ./java/lang/System.java ./java/lang/String.java ./java/lang/Throwable.java ./java/lang/Integer.java ./java/lang/Float.java ./java/lang/Double.java"
